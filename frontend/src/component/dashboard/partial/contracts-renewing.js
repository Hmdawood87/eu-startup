...
import {Btn, colorPrimary3} from "../../../globalStyle";
...
class ContractsRenewing extends Component {
    render() {
        return (
            <SlideContent>
                    ...
                    <Form.Row className="align-items-center justify-content-center mb-2 border-bottom">
                        <Col xl="4" className="mb-3">
                            <div className="mr-xl-5 border-right">
                                <UserMedia
                                    mediaStyle="primary-3"
                                    avatarSize="lg"
                                    avatarVariant="primary3"
                                    avatarClass="mr-3"
                                    avatarImg={User}
                                    name="Jonathan B."
                                    ...
                                    iconColor={colorPrimary3}
                                />
                            </div>
                        </Col>
                        <Col xl="4" className="mb-3">
                            <div className="mr-xl-4 border-right">
                                <LocationMedia
                                    mediaStyle="primary-3"
                                    isPropertyName={true}
                                    isPropertyArea={true}
                        ...
                        <Col xl="4" className="mb-3">
                            <ContractMedia
                                ...
                                RenewalContract="overdue"
                                RenewalDate="April 26, 2020"
...
export default ContractsRenewing;
